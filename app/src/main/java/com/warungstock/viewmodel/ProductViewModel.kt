...
class ProductViewModel(application: Application) : AndroidViewModel(application) {
    ...
    /** Tambah stok (MASUK) – mencatat transaksi lengkap dengan satuan */
    fun addStock(product: Product, amount: Int, note: String = "") = viewModelScope.launch {
        ...
        transactionRepo.recordTransaction(
            StockTransaction(
                ...
                retailPrice = product.sellPriceRetail, // simpan harga eceran saat ini
    ...
    /** Kurangi stok (KELUAR / jual) – mencatat transaksi dengan harga jual & eceran */
    fun reduceStock(product: Product, amount: Int, note: String = "") = viewModelScope.launch {
        ...
        transactionRepo.recordTransaction(
            StockTransaction(
                ...
                retailPrice = product.sellPriceRetail, // harga eceran saat transaksi
